...
function layout(title='DAMOLDA'){
  ...
  const nav = `
  <header class="top">
    <a class="brand" href="${href('index.html')}"><img class="brand-stamp" src="assets/damolda-stamp.png" alt=""><span class="brand-name-en">DAMOLDA</span><span class="brand-divider">|</span><span class="brand-name-ko">다몰다</span></a>
