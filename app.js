...
function layout(title='DAMOLDA'){
  ...
  const nav = `
  <header class="top">
    <a class="brand" href="${href('index.html')}"><img class="brand-mark" src="assets/damolda-mark.png" alt=""><span class="brand-en">DAMOLDA</span><span class="brand-divider">|</span><span class="brand-ko">다몰다</span></a>
